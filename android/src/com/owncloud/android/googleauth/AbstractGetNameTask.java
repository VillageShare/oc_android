...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void>{
    ...
    protected void onError(String msg, Exception e) {
        ...
        //Toast.makeText(mActivity, msg, Toast.LENGTH_SHORT).show();  // will be run in UI thread
    }
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        //URL url = new URL("https://www.googleapis.com/auth/youtube");
        //Log.d(TAG, "url: "+url);
        //HttpURLConnection con = (HttpURLConnection) url.openConnection();
        //int sc = con.getResponseCode();
        //if (sc == 200) {
          //  Log.d(TAG, "Returned 200--Success!");
            //YouTubeUpload ytu = new YouTubeUpload(mActivity, token, "videopath", "videotile", "description", null);
            //ytu.uploadYouTubeVideo();
          // Permission received
            /* TODO upload video */
          ...
          return;
        //} else if (sc == 401) {
        //    Log.d(TAG,"Returned 401");
        //    GoogleAuthUtil.invalidateToken(mActivity, token);
        //    onError("Server auth error, please try again.", null);
        //    Log.i(TAG, "Server auth error: " + readResponse(con.getErrorStream()));
        //    return;
        //} else {
        //  Log.d(TAG,"Returned "+sc);
